  ...
  return (
    <>
      ...
      <div className="mobileTablet">
        ...
        <div className="imgshowcaseDesktop"></div>
        ...
        <div className="about">
          ...
          <div className="ratingAndReviews">
            ...
            <div className="review">{produs.numberReviews} REVIEWS</div>
          </div>
          <div className="price">
            ${(produs.price - (produs.price % 100)) / 100}.{produs.price % 100}
          </div>
          <div className="description">{produs.description}</div>
